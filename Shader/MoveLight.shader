Shader "Custom/MoveLight"
{
    Properties
    {
        ...
        _Metallic("Metallic", Range(0,1)) = 0.0
            ...
            //流光图
        _LightTex("MoveLight Texture",2d) = "white"{}
        //遮罩图
        ...
        SubShader
        {
            ...
            void surf(Input IN, inout SurfaceOutputStandard o)
            {
                ...
                //获取显示流光的位置
                fixed maskC = tex2D(_MaskTex, IN.uv_MainTex).b;
                //叠加颜色
                 fixed4 c = tex2D(_MainTex, IN.uv_MainTex) * _Color + light * _MoveLightColor * maskC;
                 o.Albedo = c.rgb;
